...
from neuralgym import callbacks
from neuralgym import data
from neuralgym.train import MultiGPUTrainer
...
if __name__ == "__main__":
    ...
    if FLAGS.val:
        ...
        for i in range(FLAGS.static_view_size):
            ...
            static_images = data.DataFromFNames(
    ...
    discriminator_training_callback = callbacks.SecondaryMultiGPUTrainer(
    ...
    trainer.add_callbacks([
        ...
        callbacks.WeightsViewer(),
        callbacks.ModelRestorer(trainer.context['saver'], dump_prefix=FLAGS.model_restore+'/snap', optimistic=True),
        callbacks.ModelSaver(FLAGS.train_spe, trainer.context['saver'], FLAGS.log_dir+'/snap'),
        callbacks.SummaryWriter((FLAGS.val_psteps//1), trainer.context['summary_writer'], tf.summary.merge_all()),
    ])
    # launch training
    trainer.train()
